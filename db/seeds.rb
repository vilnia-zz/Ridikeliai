...
ingredients_recipes = Ingredient_recipes.create([{ingredient_id: ingredients.find(1), recipe_id: 1,
						 ...
						 {ingredient_id: ingredients.find(8), recipe_id: 1,
							measurement_id: measurements.find(7), quantity: 250},
						 {ingredient_id: ingredients.find(9), recipe_id: 1,
							measurement_id: measurements.find(9), quantity: 1},
						 {ingredient_id: ingredients.find(3), recipe_id: 2,
							measurement_id: measurements.find(8), quantity: 5},
						 {ingredient_id: ingredients.find(6), recipe_id: 2,
							measurement_id: measurements.find(4), quantity: 2},
						 {ingredient_id: ingredients.find(8), recipe_id: 2,
							measurement_id: measurements.find(3), quantity: 3},
						 {ingredient_id: ingredients.find(9), recipe_id: 2,
							measurement_id: measurements.find(9), quantity: 3},
						 {ingredient_id: ingredients.find(1), recipe_id: 3,
							measurement_id: measurements.find(2), quantity: 300},
						 {ingredient_id: ingredients.find(2), recipe_id: 3,
							measurement_id: measurements.find(2), quantity: 100},
						 {ingredient_id: ingredients.find(4), recipe_id: 3,
							measurement_id: measurements.find(8), quantity: 6},
						 {ingredient_id: ingredients.find(5), recipe_id: 3,
							measurement_id: measurements.find(2), quantity: 100},
						 {ingredient_id: ingredients.find(2), recipe_id: 4,
